...
namespace WPXMaintenanceProLight\WPBones\View;
...
class View
{
    ...
    public function render($asHTML = false)
    {
        ...
        $func = function () {
            ...
            if (! class_exists('WPXMaintenanceProLight\Html')) {
                class_alias('\WPXMaintenanceProLight\WPBones\Html\Html', 'WPXMaintenanceProLight\Html', true);
            }
